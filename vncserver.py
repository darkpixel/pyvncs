...
class ClientThread(Thread):
    ...
    def run(self):
        _debug(
            "[+] New server socket thread started for " + self.ip + ":" + str(self.port)
        )
...
def main(argv):
    ...
    parser.add_argument(
        ...
        "--listen-address",
        dest="listen_addr",
        help="Listen in this address, default: %s" % ("0.0.0.0"),
        required=False,
        default="0.0.0.0",
    )
    parser.add_argument(
        ...
        "--port",
        dest="listen_port",
        help="Listen in this port, default: %s" % ("5901"),
        type=int,
        required=False,
        default="5901",
    )
    ...
    parser.add_argument(
        "-P",
        "--vncpassword",
        help="Sets authentication password",
        required=True,
        dest="vnc_password",
    )
    parser.add_argument(
